...
/* Returns a pointer to the ready list */
struct list *
get_ready_list()
{
  return &ready_list;
...
bool
order(const struct list_elem * a, const struct list_elem * b, void *aux UNUSED)
{
  struct thread * t1 = (struct thread *) list_entry(a, struct thread, elem);
  struct thread * t2 = (struct thread *) list_entry(a, struct thread, elem);  
  
  return t1 ->priority > t2 -> priority;
}

bool
order_by_ticks(const struct list_elem * a, const struct list_elem * b, void *aux UNUSED)
{
  struct thread * t1 = (struct thread *) list_entry(a, struct thread, elem);
