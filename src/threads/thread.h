...
struct thread
  {
    ...
    /* Number of ticks left for the thread to sleep */
    int64_t num_ticks;
...
bool order(const struct list_elem * temp, const struct list_elem * temp2, void *aux UNUSED);
bool order_by_ticks(const struct list_elem * temp, const struct list_elem * temp2, void *aux UNUSED);
